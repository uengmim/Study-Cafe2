    ...
    function test() {
        ...
        btnChange(res, s_b);
            ...
            <table class="tableLayer" align="center">
                <tr> <!--1-->
                    <td class="seat" colspan="2" rowspan="4"><input type="button" name="cSeat" class="usable" onclick="setItem('세미나실 A');" value="세미나실 A">
                    <td></td>''
                ...
                <tr> <!--2-->
                    ...
                    <td></td> <td></td> <td></td> <td></td>
                    <td class="seat"colspan="2" rowspan="2"><button id="c_a" name="cSeat" class="usable" onclick="setItem('컨테이너실 A');">컨테이너실 A</button></td>
                </tr>
                <tr> <!--3-->
                    <td></td>
    ...
    <div class="downside">
        <div class="selected">
            <table class="choosenLayer">
                <tr>
                    <td>선택 시간:</td><td id="cTime" name="cTime"><%=request.getParameter("time")%></td>
                </tr>
                <tr>
                    <td>선택 좌석:</td><td><select name="cSeat">
                  ...
                  <td>선택 좌석:</td><td><select name="cTime">
